    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 p-8 sm:p-12">
        ...
        <div className="prose prose-blue max-w-none text-gray-700 space-y-6">
          ...
          <p>The AML Compliance Officer is the person, duly authorized by BitFast Xchange, whose responsibility is to implement and effectively monitor the application and enforcement of the AML/KYC policy as outlined in this document. The AML Compliance Officer is obliged to oversee and conduct effective monitoring of all aspects of BitFast Xchange’s anti-money laundering and counter-terrorist financing. Any suspicious behavior or activities should be reported to the AML Compliance Officer.</p>
          <p>Communication with the AML Compliance Officer in regards to this Policy is conducted via compliance@bitfast-xchange.com.</p>
